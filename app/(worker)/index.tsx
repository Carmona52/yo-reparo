        ...
        <ThemedView style={G.flex1}>
            <SafeAreaView style={G.flex1} edges={['top']}>
                ...
                >
                    ...
                    {/* Calendario */}
                    <View style={[G.calendarCard, {backgroundColor: surfaceBg, borderColor}]}>
                            ...
                            {calendarDays.map((date, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {hasTasks && (
                                            <View
                                                style={[G.dotIndicator, {backgroundColor: isSelected ? COLORS.onPrimary : COLORS.primary}]}/>
                                        )}
                                    </TouchableOpacity>
                                );
                            })}
                            ...
                            selectedDayTasks.map((task) => (
                                ...
                                >
                                    <View style={[G.taskCard, {
                                        ...
                                        <View style={[G.taskDivider, {backgroundColor: borderColor}]}/>
                                        <View style={G.taskDetailsColumn}>
                                            <ThemedText type="defaultSemiBold"
                                                        style={[G.taskTitle, {color: textColor}]}>
                                                {task.title}
                                            </ThemedText>
